...
def load_txt_embeddings(path):
    """
    Load word2vec-style txt embeddings.
    ...
    with open(path, "r", encoding="utf-8") as f:
        ...
        print(f"[INFO] Expected nodes: {num_nodes:,}")
    ...
    print(f"[INFO] Loaded embeddings matrix shape: {embeddings_matrix.shape}")
